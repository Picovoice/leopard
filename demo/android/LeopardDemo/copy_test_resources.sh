...
cp ../../../lib/common/leopard_params.pv ./leopard-demo-app/src/main/assets/leopard_params.pv
cp ../../../lib/common/leopard_params.pv ./leopard-demo-app/src/androidTest/assets/test_resources/leopard_params.pv
